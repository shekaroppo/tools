...
+------+-------+-------+---------+-----------+---------+------------+---------+-------------+
|    2 | mf2   | type2 |      43 | 20000.000 |  35.000 |  28000.000 |  40.000 |    1639.359 |
|    1 | mf1   | type1 |      43 | 20000.000 | 150.000 |  75000.000 | 275.000 | 7457361.046 |
|      | Total |       |      43 | 40000.000 |         | 103000.000 | 157.500 |  306682.092 |
+------+-------+-------+---------+-----------+---------+------------+---------+-------------+
`
	assertCommandOutput(t, args, expOutput)
}
